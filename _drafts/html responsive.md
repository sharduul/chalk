...
{% include image.html path="responsive.png" path-detail="responsive.png" alt="What Is
Responsive" %}
...
{% include image.html path="360 X 740.png" path-detail="360 X 740.png" alt="360 X 740.png" %}

In the above picture ou can observe that the dimension of the browser is **360 X 740**.The content is adjusted to size of the browser.

Let's change the dimension of the browser and check again.

{% include image.html path="800 * 1280.png" path-detail="800 * 1280.png" alt="800 * 1280.png" %}
